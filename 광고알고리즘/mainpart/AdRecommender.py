...
# ===== 군집 기반 추천 함수 래퍼 =====
def recommend_by_cluster(user_id: str, top_n: int = 12) -> pd.DataFrame:
    from user_clustering import pivot_rate
    import pandas as pd

    # 사용자 ID 기반 세그먼트 매핑 (현재는 임시로 user_1 고정)
    user_segment = '중장년_40-50대_남성'
    ...
    return recs[[
        ...
        "광고주명", "광고회사명", "광고제작사", "AISAC_URL", "실제재생초수"
    ]]
